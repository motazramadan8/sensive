...
<section class="section-margin--small section-margin">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <form action="{{ route('register.store') }}" class="form-contact contact_form" method="post" novalidate="novalidate">
                    @csrf
                    ...
                    <div class="d-flex justify-content-end align-items-center">
                        <a href="{{ route('login') }}" class="mr-2">Do you have account already?</a>
